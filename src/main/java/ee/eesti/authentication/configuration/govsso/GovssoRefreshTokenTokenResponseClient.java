...
public class GovssoRefreshTokenTokenResponseClient
    ...
    private RequestEntity<?> toRequestEntity(Request request) {
        ...
        if (request.representablePartyCode != null) {
            params.add(OAuth2ParameterNames.SCOPE, "representee." + request.representablePartyCode);
        }
    ...
    public static class Request extends AbstractOAuth2AuthorizationGrantRequest {
        ...
        private final String representablePartyCode;
        ...
        public Request(
            ...
            this.representablePartyCode = representablePartyCode;
        }
    }
