...
import ee.eesti.authentication.service.GovssoAccessTokenValidator;
 ...
 */
public class GovssoAccessTokenDecoderFactory implements JwtDecoderFactory<ClientRegistration> {
    ...
    public GovssoAccessTokenDecoderFactory(
    ...
    private NimbusJwtDecoder doCreateDecoder(ClientRegistration clientRegistration) {
        ...
        jwtDecoder.setJwtValidator(new DelegatingOAuth2TokenValidator<>(
                ...
                new GovssoAccessTokenValidator(clientRegistration, audience),
